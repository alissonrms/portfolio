...
const Hero = ({ mainData }: HeroProps) => {
  ...
  return (
    <section
      ...
      } relative min-h-[100dvh] w-full mx-auto overflow-hidden`}
    >
      <div className="absolute -z-10 min-h-[100dvh] h-full w-full">
        <Image
          src="/herobgc.jpg"
          fill
          loading="lazy"
