...
const Projects = ({ projectsData }: Props) => {
  ...
  useEffect(() => {
    filterProjects(
      categories.includes("Profissional") ? "Profissional" : categories[0]
    );
    // eslint-disable-next-line react-hooks/exhaustive-deps
  }, []);

  return (
    <SectionWrapper id="projetos" className="mx-4 md:mx-0 min-h-[100dvh] pt-12">
      <h2 className="text-4xl text-center">Projetos</h2>
